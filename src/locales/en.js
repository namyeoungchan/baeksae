export const en = {
  nav: {
    ...
    about: 'About',
    products: 'Products', 
    antioxidant: 'Antioxidant Farming',
    facility: 'Facilities',
    contact: 'Contact'
  },
  hero: {
  ...
  about: {
    ...
    patents: {
      ...
      items: [
        {
          title: 'Method for Increasing Red Pepper Fruit Yield',
          description: 'Patent No. 10-2294547 (PCT Application: WO2021-007291)', 
          period: 'Implementation Period: 2021.03.23 ~ 2025.03.31'
        },
        {
          title: 'Liquid Fertilizer Composition for Broccoli Cultivation and Its Use',
          description: 'Patent No. 10-1922442, 10-2175155',
      ...
      viewOriginal: 'View Original Certificate'
    }
  },
  products: {
    title: 'Products',
    currentSale: 'Now Available',
    comingSoon: 'Coming Soon',
    orderNow: 'Order Now',
    preparing: 'In Preparation',
    items: [
      {
        title: 'Premium Traditional Kimchi',
        description: 'Premium kimchi made with traditional recipes passed down for three generations. Made exclusively with domestic ingredients for deep, rich flavors.'
      },
      {
        title: 'Antioxidant Red Peppers',
    ...
    benefits: [
      {
        ...
        description: 'Up to 300% higher antioxidant content compared to conventional farming methods for better health.'
      },
      {
        title: 'Eco-friendly Cultivation',
        description: 'Cultivated using natural, environmentally friendly methods without chemical fertilizers or pesticides.'
      },
      {
        title: 'Extended Freshness',
        description: 'Antioxidant compounds help maintain freshness for longer periods, ensuring lasting quality.'
      },
      {
        title: 'Safe Food',
        description: 'Strict quality control ensures safe agricultural products that the whole family can trust.'
      }
    ]
  },
  facility: {
    title: 'Cultivation Facilities',
    subtitle: 'Introducing Our Advanced Antioxidant Cultivation Facilities',
    items: [
      {
  ...
  contact: {
    ...
    addressDetail1: '1 Chungdae-ro, Seowon-gu, Cheongju-si, Chungcheongbuk-do',
    addressDetail2: 'Room 972-9, Bldg E9, Industry-Academic Cooperation Foundation'
  },
  footer: {
    copyright: '© 2025 Baekse Agriculture. All rights reserved.'
  }
};
